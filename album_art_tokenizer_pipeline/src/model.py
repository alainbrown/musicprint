...
class VectorQuantizer(nn.Module):
    """
    The 'Vocabulary' of the image tokenizer.
    Maps continuous vectors to the nearest discrete codebook entry.
    """
    ...
    def forward(self, inputs):
        ...
        # Encoding: Choose nearest codebook vector
